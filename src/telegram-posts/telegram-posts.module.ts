...
} from "../AllCategoriesForSearch/equip-repair-maintenance/equip-repair-maintenance.module";
...
@Module({
  ...
  providers: [TelegramPostsService, LogsService, RedisService, RepositoryPostsAdd],
